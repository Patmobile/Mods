...
public class BlockStufe extends BlockSlab implements IBucketPickupHandler, ILiquidContainer {
    ...
    public BlockStufe(String Name, Material material,float hardnessAndResistance, SoundType soundType) {
