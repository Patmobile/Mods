...
public class BlockTreppe extends BlockStairs implements IBucketPickupHandler, ILiquidContainer {
    ...
    protected static final VoxelShape AABB_SLAB_TOP = BlockStufe.TOP_SHAPE;
    protected static final VoxelShape AABB_SLAB_BOTTOM = BlockStufe.BOTTOM_SHAPE;
    ...
    public static boolean isBlockStairs(IBlockState state) {
        return state.getBlock() instanceof net.minecraft.block.BlockStairs || state.getBlock() instanceof BlockTreppe;
    }
