...
public class ParallelDimensionBiomeProvider extends OverworldBiomeProvider {
    ...
    public ParallelDimensionBiomeProvider(ParallelDimensionBiomeProviderSettings p_i48971_1_) {
        super(p_i48971_1_);
        this.biomes = new Biome[]{ParallelDimensionMod.BiomeKirschwald};
        WorldInfo lvt_2_1_ = p_i48971_1_.getWorldInfo();
        ParallelDimensionGenSettings lvt_3_1_ = p_i48971_1_.getGeneratorSettings();
        GenLayer[] lvt_4_1_ = ParallelDimensionLayerUtil.buildOverworldProcedure(lvt_2_1_.getSeed(), lvt_2_1_.getTerrainType(), lvt_3_1_);
