...
public class ItemInit 
{
    ...
    SteinHose = new ArmorSet("steinarmor_leggins", InitArmorSets.STEINARMOR, EntityEquipmentSlot.HEAD, MoreItemsMod.MoreItemsTab).addToRegistryList();
    ...
    SmaragdHose = new ArmorSet("smaragdarmor_leggins", InitArmorSets.SMNARAGDARMOR, EntityEquipmentSlot.HEAD, MoreItemsMod.MoreItemsTab).addToRegistryList();
	...
	ObsidianHose = new ArmorSet("obsidianarmor_leggins", InitArmorSets.OBSIDIANARMOR, EntityEquipmentSlot.HEAD, MoreItemsMod.MoreItemsTab).addToRegistryList();
	...
	VerstaerkteDiamantHose = new ArmorSet("verstaerktediamantarmor_leggins", InitArmorSets.VERSTAERKTEDIAMANTARMOR, EntityEquipmentSlot.HEAD, MoreItemsMod.MoreItemsTab).addToRegistryList();
