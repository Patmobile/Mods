...
public class ParallelDimensionTeleportManager extends TileEntity
{
    ...
    public ParallelDimensionTeleportManager()
    {
        super(null);
    }
    ...
    public NBTTagCompound write(NBTTagCompound nbt)
    {
        ...
        nbt.setInt(dme, ParallelDimensionMod.ParallelDimensionID);
    ...
    public static void teleEntity(Entity entity)
    {
        if(!entity.world.isRemote) {
            if (!entity.isBeingRidden() && entity.getRidingEntity() == null) {
                ...
                if (entity.timeUntilPortal > 0) {
                ...
                } else if (entity.dimension != ParallelDimensionMod.ParallelDimensionTyp) {
                    ...
                    if (prevX2 == 0.0 && prevY2 == 0.0 && prevZ2 == 0.0) {
                        ...
                        entity.changeDimension(ParallelDimensionMod.ParallelDimensionTyp, new TeleporterParallelDimension(server.getWorld(ParallelDimensionMod.ParallelDimensionTyp)));
                    ...
                    setDme22();
                    setTestXYZ(entity.posX, entity.posY, entity.posZ);
                    entity.changeDimension(DimensionType.OVERWORLD, new TeleporterParallelDimension(server.getWorld(DimensionType.OVERWORLD)));
                    //tryToPutInPortal(entity);
                }
            }
        }
    ...
    public static void tele(EntityPlayer player)
    {
        if(!player.world.isRemote) {
            if ((player.getRidingEntity() == null) && ((player instanceof EntityPlayerMP))) {
                ...
                if (player1.timeUntilPortal > 0) {
                ...
                } else if (player1.dimension != DimensionManager.getRegistry().get(ParallelDimensionMod.ParallelDimensionID)) {
                    ...
                    if (prevX2 == 0.0 && prevY2 == 0.0 && prevZ2 == 0.0) {
                        ...
                        WorldServer toWorld = mcServer.getWorld(DimensionManager.getRegistry().get(ParallelDimensionMod.ParallelDimensionID));
                        ...
                        player.changeDimension(DimensionManager.getRegistry().get(ParallelDimensionMod.ParallelDimensionID), new TeleporterParallelDimension(toWorld));
                    ...
                    player.changeDimension(DimensionType.OVERWORLD, new TeleporterParallelDimension(toWorld));
